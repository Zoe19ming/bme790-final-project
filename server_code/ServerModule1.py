...
# ---------------------------------------------------
def Task1_from_df(Cleaned_raw, n_perm=1000, random_state=42):
  """
...
def independency_check(file_media, n_perm=200):
  try:
    ...
    print("checkpoint")
    return ("Conclusion for part 1: Dependent for revisits; Cannot be considered as separate dataset")
    res = Task1_from_df(df, n_perm=200, random_state=42)
